    ...
    <div className="bg-gray-700/50 rounded-lg p-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <h4 className="text-sm font-medium text-white">{processType.processType}</h4>
        </div>
        <button
      ...
      {isExpanded && (
        <div className="mt-4 space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className="space-y-4">
              <div className="bg-gray-800/50 rounded-lg p-3">
                ...
                <p className="text-sm text-gray-300">{processType.keyObservation}</p>
              </div>
              <div className="bg-gray-800/50 rounded-lg p-3">
                <div className="text-sm font-medium text-red-400 mb-2">Failure Cause</div>
                <p className="text-sm text-gray-300">{processType.failureCause}</p>
              </div>
            </div>
            <div className="space-y-4">
              <div className="bg-gray-800/50 rounded-lg p-3">
                <div className="text-sm font-medium text-green-400 mb-2">Corrective Action</div>
                <p className="text-sm text-gray-300">{processType.correctiveAction}</p>
              </div>
              <div className="bg-gray-800/50 rounded-lg p-3">
                <div className="text-sm font-medium text-yellow-400 mb-2">Preventive Action</div>
                <p className="text-sm text-gray-300">{processType.preventiveAction}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-800/50 rounded-lg p-3">
            <div className="text-sm font-medium text-gray-400 mb-2">Excerpt from Violation</div>
            <p className="text-sm text-gray-300 italic">{processType.excerptFromViolation}</p>
          </div>
        </div>
      )}
    </div>
